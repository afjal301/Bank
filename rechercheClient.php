...
if(isset($_GET["action"]) && $_GET["action"]==="modify"  && isset($_GET["name"])){
    session_start();
    $value=$_GET["name"];
    ...
    <div class="rechercheCli">
        ...
        <table class="table">
            <tr>
                ...
                <td style="background-color: rgb(12, 112, 158);color: white;font-size: 1.2em;">Adresse</td>
            ...
            <tr>
                ...
                <?php endforeach?>
                <td>
                <a href="rechercheClient.php?name=<?=$key["num_compte"]?>&&action=delete"><button class="btn btn-danger">Delete</button></a>
                    
                </td>
                <td>
                <a href="rechercheClient.php?name=<?=$key["num_compte"]?>&&action=modify"><button class="btn btn-primary">Modify</button></a>
                </td>
            </tr>
            <?php endforeach?>
        </table>
